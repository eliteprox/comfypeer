...
import { settingsCheckoutUrls, startBillingCheckout } from "@/lib/billing-plans";
...
export async function POST(request: NextRequest) {
  ...
  const defaults = settingsCheckoutUrls();
  try {
    ...
    return pmtHouseErrorResponse(error, "Failed to start checkout");
  }
}
